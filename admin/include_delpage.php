<?php 
  ...
  if ($page!=1) {
?>
      <li><a href="<?php $_SERVER['PHP_SELF'] ?>?s=2&g=3&p=<?php echo ($page-1) ?>">&laquo;上一页</a></li>
<?php }
  //计算偏移量2
?>
<?php  
...
?>
      <li><a href="<?php $_SERVER['PHP_SELF'] ?>?s=2&g=3&p=1">1</a></li>
...
<?php //输出页码
   for($i=$start;$i<=$end;$i++){ 
?>
    <li><a href="<?php $_SERVER['PHP_SELF'] ?>?s=2&g=3&p=<?php echo $i ?>"><?php echo $i ?></a></li>
<?php }
?>
<?php
    //尾部省略
...
?>
      <li class="disabled"><span>...</span></li>
      <li><a href="<?php $_SERVER['PHP_SELF'] ?>?s=2&g=3&p=<?php echo $pagecount ?>"><?php echo $pagecount ?></a></li>
<?php   }
    //显示页次 ?>
...
if (!(1<=$page&&$page<=$pagecount)) {
     echo "<script>window.location.href='".$_SERVER['PHP_SELF']."?s=2&g=3&p=1';</script>";
   }
?>
